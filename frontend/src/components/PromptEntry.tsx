...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 overflow-y-auto p-4">
      <header className="sticky top-0 z-50 p-4 flex justify-end items-center">
      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-8rem)]">
        <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-3xl my-8">
