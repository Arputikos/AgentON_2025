    ...
    <div className="h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className='p-0'>
            <label htmlFor="prompt" className="block text-2xl font-medium text-gray-700 mb-3 p-1">
          ...
          <label htmlFor="prompt" className="block text-xl font-medium text-gray-700 mb-3 p-1">
            ...
            <input
              ...
              className="w-full px-5 py-4 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-lg"
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 text-lg"
